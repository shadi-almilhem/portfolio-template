...
export function ThemeToggle() {
  ...
  return (
    ...
    >
      ...
      <MoonStar className="hidden h-6 w-6 fill-zinc-700 stroke-zinc-500 transition dark:block [@media(prefers-color-scheme:dark)]:group-hover:stroke-violet-500 [@media_not_(prefers-color-scheme:dark)]:fill-violet-400/10 [@media_(prefers-color-scheme:dark)]:stroke-violet-500/80" />
    </button>
  );
}
