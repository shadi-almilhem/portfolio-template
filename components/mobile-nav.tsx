...
interface MobileNavigationProps extends React.HTMLAttributes<HTMLElement> {
  ...
  return (
    <Popover {...props}>
      ...
      <PopoverPanel
        focus
        transition
        className="fixed inset-x-4 top-24 z-50 origin-top transition-all rounded-xl bg-white p-8 ring-1 ring-zinc-900/5 duration-150 data-[closed]:scale-95 data-[closed]:opacity-0 data-[enter]:ease-out data-[leave]:ease-in dark:bg-zinc-900 dark:ring-zinc-800"
      >
        ...
        <nav className="mt-6">
          <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
            ...
            {/* Conditionally render Projects link */}
